...
extern uint8_t* tc_calloc(uint64_t p_count, uint64_t p_size);

extern void tc_free(uint8_t* p_ptr);
...
uint8_t* Malloc_5cdcff11cc4fe0b7702dcefd8e40a3205be2181cfbca6974337e1a1f974cd4e8(uint64_t p_count, uint64_t p_size, uintptr_t* p_group) {
    ...
    uint64_t v_s;
    v_s = tmp_10;
    uint8_t* tmp_12 = tc_calloc(1ull, v_s);
    uint8_t* v_alloc;
    v_alloc = tmp_12;
...
void Free_17cd220e161d0642d8eb85204f15c78e318810795cb3cfa0160f7806603a731a(uintptr_t* p_group) {
    ...
    bool tmp_6 = tmp_2 || tmp_5;
    if (tmp_6) {
        return;
    };
    struct groupHeader_4db78c2db99b0ed1e81ab5015e323d4208b3393d4e914d75bf3e32955726accc* tmp_7 = (struct groupHeader_4db78c2db99b0ed1e81ab5015e323d4208b3393d4e914d75bf3e32955726accc*)(*p_group);
    struct groupHeader_4db78c2db99b0ed1e81ab5015e323d4208b3393d4e914d75bf3e32955726accc* tmp_8 = last_16bd55673192911524f821df8b5ae2aab334d57389291ccf002f3ba68cdb9072(tmp_7);
    struct groupHeader_4db78c2db99b0ed1e81ab5015e323d4208b3393d4e914d75bf3e32955726accc* v_h;
    v_h = tmp_8;
    for (;;) {
        bool tmp_10 = v_h != ((struct groupHeader_4db78c2db99b0ed1e81ab5015e323d4208b3393d4e914d75bf3e32955726accc*)0);
        bool tmp_11 = !tmp_10;
        if (tmp_11) {
            break;
        };
        struct groupHeader_4db78c2db99b0ed1e81ab5015e323d4208b3393d4e914d75bf3e32955726accc* tmp_12 = v_h -> prev;
        struct groupHeader_4db78c2db99b0ed1e81ab5015e323d4208b3393d4e914d75bf3e32955726accc* v_h2;
        v_h2 = tmp_12;
        uint8_t* tmp_14 = (uint8_t*)v_h;
        tc_free(tmp_14);
        v_h = v_h2;
    };
    *p_group = 0ull;
